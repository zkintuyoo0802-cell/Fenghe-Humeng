...
(function () {
  ...
  function switchView(view) {
    ...
    els.sidebarDcf.classList.toggle("hidden", !showDcf);
    ...
    els.panelDcf.classList.toggle("hidden", !showDcf);
